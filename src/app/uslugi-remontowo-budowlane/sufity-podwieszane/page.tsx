...
const schema = {
	...
	'@type': 'Service',
	'@id':
		'https://pro-wnetrze.pl/uslugi-remontowo-budowlane/sufity-podwieszane#service',
	isPartOf: {
		'@type': 'CollectionPage',
		...
		text: (
			<>
				...
				<span>
					...
					<Link href='/wykonczenia-wnetrz'>wykończenia wnętrz</Link> i chcesz,
					aby Twój sufit podwieszany idealnie komponował się z aranżacją,

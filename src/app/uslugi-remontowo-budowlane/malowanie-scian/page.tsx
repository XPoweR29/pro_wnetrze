...
const schema = {
	...
	'@type': 'Service',
	'@id':
		'https://pro-wnetrze.pl/uslugi-remontowo-budowlane/malowanie-scian#service',
	isPartOf: {
		'@type': 'CollectionPage',
		...
		text: (
			<>
				...
				<span>
					...
					<Link href='/tynki-dekoracyjne'>technikami dekoracyjnymi</Link> ścian,
					które mogą stanowić doskonałe uzupełnienie tradycyjnego malowania.
					Zadbaj o malowanie ścian w swoim wnętrzu i ciesz się odmienioną
					przestrzenią na lata.
				</span>
			</>
		),
		image: image1,

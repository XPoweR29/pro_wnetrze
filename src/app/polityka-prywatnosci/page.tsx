		...
		<article className={styles.policy}>
			<Wrapper>
				...
				<ul>
					...
					<li>
						<p>
							...
							skutek świadomej lub nieświadomej działalności Użytkownika,
							wirusów, koni trojańskich i innego oprogramowania szpiegującego,
							którymi może być lub było zainfekowane Urządzenie Użytkownika.
				...
				<p>
					...
					plikach cookies. Część danych (bez danych identyfikujących) może być
				...
				<p>
					...
					<strong>
						<a
							rel='nofollow external'
							href='https://www.pro-wnetrze.pl/polityka-prywatnosci'>
							vercel
						</a>
					</strong>
					. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane
					i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w Polsce.
					Istnieje możliwość dostępu do danych wskutek prac serwisowych
					realizowanych przez personel usługodawcy. Dostęp do tych danych
						...
						<ul>
							...
							<li>
								...
								<small>
									...
									uzasadnionego interesu realizowanych przez administratora lub
				...
				<ul>
					<li>
						<p>
							<strong>Adres pocztowy</strong> - PROWnętrze, ul. Parkowa 43,
					...
					<li>
						<p>
							<strong>Połączenie telefoniczne</strong> - +48 515-484-232
						</p>
					</li>
				</ul>
